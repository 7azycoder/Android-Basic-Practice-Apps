...
/**
 * Created by Youvraaj on 12/13/2015.
 */
public class PlaceAdapter extends ArrayAdapter<Place> {
    ...
    public View getView(int position,View convertView, ViewGroup parent){
        ...
        //if we currently dont have a row View to use
        if(row==null){
            //create a new View
        ...
        holder.zipView.setText(String.valueOf(place.mZipCode)); // always pay attention to your datatypes here

        //for getting the image
        int resId = mContext.getResources().getIdentifier(place.mNameOfImage, "drawable",mContext.getPackageName());
        holder.imageView.setImageResource(resId);

        //returning the row view ( because this is called a getView after all
        return row;
    }
